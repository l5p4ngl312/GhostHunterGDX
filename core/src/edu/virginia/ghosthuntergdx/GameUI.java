...
public class GameUI extends Actor{
	...
	public void draw(Batch batch, float parentAlpha)
	{
		...
		if(displayAmmoIcon)
		{
			...
			ammoCountFont.draw(batch, reserveCount+" - "+clipCount,Gdx.graphics.getWidth()-Gdx.graphics.getWidth()/7f-ammoIcon.getOriginX()+5,Gdx.graphics.getHeight()-10-ammoIcon.getOriginY());
		}
	}
	...
	public void setAmmoIcon(ammoType t)
	{
		...
		if(displayAmmoIcon)
		{
			ammoIcon.setSize(ammoIcon.getWidth()/Item.itemPixelToWorld*Consts.BOX_TO_WORLD, ammoIcon.getHeight()/Item.itemPixelToWorld*Consts.BOX_TO_WORLD);
			ammoIcon.setOrigin(ammoIcon.getWidth(),ammoIcon.getHeight());
			ammoIcon.setPosition(Gdx.graphics.getWidth()-Gdx.graphics.getWidth()/7f-ammoIcon.getOriginX()+5,Gdx.graphics.getHeight()-20-ammoIcon.getOriginY()+5);
