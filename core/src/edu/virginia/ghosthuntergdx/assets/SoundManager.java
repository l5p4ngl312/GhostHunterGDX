...
public class SoundManager {
	...
	public static void LoadSounds()
	{
		...
		ghostAlert = Gdx.audio.newSound(Gdx.files.internal("sound/ghostAlert.mp3"));
		...
		zombieHit = Gdx.audio.newSound(Gdx.files.internal("sound/zombieHit.wav"));
		zombieAttack = Gdx.audio.newSound(Gdx.files.internal("sound/zombieMoan.wav"));
	}
