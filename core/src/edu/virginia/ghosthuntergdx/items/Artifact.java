...
public class Artifact extends Actor implements Collider{
	...
	public Artifact(Vector2 pos)
	{
		...
		getSprite().setPosition(pos.x*Consts.BOX_TO_WORLD, pos.y*Consts.BOX_TO_WORLD);
		...
		mBody = Physics.createCircleBody(BodyType.StaticBody, mDef, getSprite(),false);
	...
	public void draw(Batch batch, float parentAlpha)
	{
		...
		getSprite().setPosition(getX()*Consts.BOX_TO_WORLD-getSprite().getOriginX(),getY()*Consts.BOX_TO_WORLD-getSprite().getOriginY());
