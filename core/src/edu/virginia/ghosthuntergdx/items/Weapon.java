...
public abstract class Weapon extends Item {
	...
	public Weapon(float price, ammoType t, int playerHoldingFrame,
			int[] fireAnimFrames, int spriteIndex) {
		super(spriteIndex);
		...
		for (int i = 0; i < fireAnimFrames.length; i++)
			animRegions.add(TextureManager.player.getRegions().get(
					fireAnimFrames[i]));
