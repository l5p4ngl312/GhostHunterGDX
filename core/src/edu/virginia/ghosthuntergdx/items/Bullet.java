...
public class Bullet extends Actor implements Collider{
	...
	public Bullet(Vector2 pos, Vector2 velocity)
	{
		...
		bulletSprite.setSize(getWidth()*Consts.BOX_TO_WORLD, getHeight()*Consts.BOX_TO_WORLD);
		bulletSprite.setOrigin(getWidth()*Consts.BOX_TO_WORLD/2,getHeight()*Consts.BOX_TO_WORLD/2);
		bulletSprite.setPosition(pos.x*Consts.BOX_TO_WORLD, pos.y*Consts.BOX_TO_WORLD);
	...
	public void draw(Batch b, float parentAlpha)
	{
		...
		bulletSprite.setPosition(getX()*Consts.BOX_TO_WORLD-bulletSprite.getOriginX(), getY()*Consts.BOX_TO_WORLD-bulletSprite.getOriginY());
		Vector3 myColor = new Vector3(bulletSprite.getColor().r,bulletSprite.getColor().g,bulletSprite.getColor().b);
